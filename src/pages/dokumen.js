...
const Document = () => {
  ...
  const getDocument = async () => {
    const response = await axios.get("https://sembappcoba.azurewebsites.net/dokumen");
    setDokumen(response.data);
  };
  const getTransaction = async () => {
    const response = await axios.get("https://sembappcoba.azurewebsites.net/transaction");
  ...
  const deleteDocument = async (id) => {
    try {
      await axios.delete(`https://sembappcoba.azurewebsites.net/dokumen/${id}`);
      getDocument();
    } catch (error) {
      console.log(error);
    }
